...
var blockOneAction = btcwire.MsgBlock{
	Header: btcwire.BlockHeader{
		Version: 1,
		PrevBlock: btcwire.ShaHash([btcwire.HashSize]byte{ // Make go vet happy.
			0x6f, 0xe2, 0x8c, 0x0a, 0xb6, 0xf1, 0xb3, 0x72,
	...
	Actions: []*btcwire.MsgAction{
		{
			Version:   1,
			Timestamp: time.Unix(0x4966bc61, 0), // 2009-01-08 20:54:25 -0600 CST
			GameID: btcwire.ShaHash([btcwire.HashSize]byte{
				0x89, 0xb7, 0x39, 0x11, 0xce, 0xdc, 0x3c, 0x87,
				0xed, 0xcb, 0xd6, 0xa1, 0x0b, 0xd0, 0xc4, 0x36,
				0x00, 0xf8, 0x8d, 0xa5, 0x02, 0xc5, 0x9f, 0x15,
				0x40, 0x85, 0x63, 0xe3, 0x37, 0x82, 0xe7, 0x37,
			}),
			PreviousMessageSignature: [65]byte{ // signature
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			...
			Author: [25]byte{ // base85 check address
				0xae, 0x13, 0x8e, 0xb5, 0x84, 0xc9, 0x53, 0xb2,
				0x4a, 0xb1, 0x7e, 0x00, 0x95, 0xa7, 0x19, 0xe7,
				0x28, 0x85, 0xf3, 0xe7, 0x34, 0x40, 0x44, 0x6d,
				0x57,
			},
			Signature: [65]byte{
				0xe2, 0x5e, 0xcf, 0x21, 0x4d, 0x3f, 0xa4, 0xeb,
				0x65, 0xc8, 0x61, 0xaa, 0x6a, 0x31, 0x07, 0x67,
				0xef, 0x00, 0x75, 0x20, 0xc6, 0xd0, 0x1d, 0x67,
				0x5b, 0x79, 0x37, 0x0f, 0xf0, 0xc9, 0x04, 0x52,
				0x3e, 0x08, 0xb6, 0x10, 0x86, 0x87, 0x12, 0x92,
				0x58, 0xfa, 0xcf, 0x12, 0xd5, 0xfe, 0x37, 0x4f,
				0x4b, 0x28, 0xb0, 0x32, 0xba, 0xd8, 0xd9, 0x03,
				0xfd, 0x47, 0x3e, 0x8a, 0xc2, 0xf9, 0xf3, 0xc9,
				0x02,
			},
			Message: []byte{0x01},
		},
...
var blockOneActionBytes = []byte{
	...
	0x01, 0x00, 0x00, 0x00, // version
	0x61, 0xbc, 0x66, 0x49, // Timestamp
	0x89, 0xb7, 0x39, 0x11, 0xce, 0xdc, 0x3c, 0x87, // GameId
	0xed, 0xcb, 0xd6, 0xa1, 0x0b, 0xd0, 0xc4, 0x36,
	0x00, 0xf8, 0x8d, 0xa5, 0x02, 0xc5, 0x9f, 0x15,
	0x40, 0x85, 0x63, 0xe3, 0x37, 0x82, 0xe7, 0x37,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Previous message signature
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00,
	0xae, 0x13, 0x8e, 0xb5, 0x84, 0xc9, 0x53, 0xb2, // Author
	0x4a, 0xb1, 0x7e, 0x00, 0x95, 0xa7, 0x19, 0xe7,
	0x28, 0x85, 0xf3, 0xe7, 0x34, 0x40, 0x44, 0x6d,
	0x57,
	0xe2, 0x5e, 0xcf, 0x21, 0x4d, 0x3f, 0xa4, 0xeb, // Signature
	0x65, 0xc8, 0x61, 0xaa, 0x6a, 0x31, 0x07, 0x67,
	0xef, 0x00, 0x75, 0x20, 0xc6, 0xd0, 0x1d, 0x67,
	0x5b, 0x79, 0x37, 0x0f, 0xf0, 0xc9, 0x04, 0x52,
	0x3e, 0x08, 0xb6, 0x10, 0x86, 0x87, 0x12, 0x92,
	...
	0xfd, 0x47, 0x3e, 0x8a, 0xc2, 0xf9, 0xf3, 0xc9,
	0x02,
	0x01, 0x00, 0x00, 0x00, // Message length
	0x01, // Message
}
