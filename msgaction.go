...
const (
	...
	minActionPayload = 4 + 32 + 65 + 25 + 65 + 4 + 1
...
func (a *MsgAction) BtcDecode(r io.Reader, pver uint32) error {
	...
	var dataLen uint32
	err = readElements(r, &a.GameID, &a.PreviousMessageSignature,
...
func (a *MsgAction) BtcEncode(w io.Writer, pver uint32) error {
	...
	err := writeElements(w, a.Version, a.GameID, a.PreviousMessageSignature,
		a.Author, a.Signature, uint32(len(a.Message)), a.Message)
	if err != nil {
		return err
	}
	return nil
